...
/// The provider-id-to-[AgentProvider] lookup every consumer goes
/// through, instead of holding a single [AgentModelClient] field
/// directly. Constructed once in `main.dart`. "Pluggable" for a compiled
