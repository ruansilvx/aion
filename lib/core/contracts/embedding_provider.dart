...
/// needing embeddings (today, only `tickets`) depends only on this interface,
/// never on the bundled implementation directly. Implemented by
/// `BundledEmbeddingProvider`
/// (`core/embeddings/bundled_embedding_provider.dart`) and provided once at
/// the app root. See `AIO-2022`.
