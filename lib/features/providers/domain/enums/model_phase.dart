...
/// The [ToolAccessTier] each [ModelPhase] actually requires — makes what
/// every call site already passes as a literal `toolsEnabled: true`/
/// `false` into declared data, used to filter which providers' models a
