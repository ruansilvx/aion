...
/// [AnthropicApiKeyRepository] — the first real consumer of that dependency;
/// everything else in the app today is `shared_preferences` (nothing else has
/// been a real secret). One key (`provider_config.anthropic_api_key`).
/// `setApiKey(null)` or an empty string deletes the key rather than storing an
/// empty value. See `AIO-110` §5.
