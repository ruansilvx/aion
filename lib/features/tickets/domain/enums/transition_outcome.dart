...
/// The terminal result of walking a project-authored [SddStage]
/// transition-precondition graph (`utils/evaluate_transition_graph.dart`) — an
...
/// see `AIO-1936`'s "Why parallel types, not shared ones." Added for
/// `AIO-1936`.
