...
/// [SkillAttachment](../entities/skill_attachment.dart) uses. See `AIO-2650`
/// §1.1.
enum SkillAttachmentKind {
  ...
  /// (`AgentRequest.toolsEnabled: true`), so the underlying coding agent's own
  /// discovered `.claude/skills/<skillName>` skill executes. Confirmed viable
  /// by the 2026-08-19 CLI-delegation spike documented in `AIO-18`'s "Explore
  /// findings" section.
  delegatedSkill,
}
