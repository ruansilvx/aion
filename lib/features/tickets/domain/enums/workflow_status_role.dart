...
/// comparisons from before this ticket-workflow-configuration change. Exactly
/// one shared-base [WorkflowStatus] must hold each value at all times;
/// [WorkflowConfigCubit](../../presentation/cubit/workflow_config_cubit.dart)
/// enforces this invariant, never the repository — see `AIO-549` §1.1.
