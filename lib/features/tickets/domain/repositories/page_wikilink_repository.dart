...
/// Parallel to `TicketLinkRepository`, not built on it — a wikilink is derived
/// from content, never user-authored, so it has no remove/retype affordance
/// and no link type. Per `AIO-963`.
