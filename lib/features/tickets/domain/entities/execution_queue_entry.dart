...
/// One persisted row of `TicketsCubit`'s coding-execution queue — either an
/// in-flight run or a still-queued one — surviving an app restart via
/// `ExecutionQueueRepository`. See `AIO-1400` §5.3.
