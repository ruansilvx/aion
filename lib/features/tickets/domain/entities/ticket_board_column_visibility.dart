...
/// project-defined status columns the user has hidden. A plain value
/// holder, mirroring [TicketListFilters](ticket_list_filters.dart) —
...
class TicketBoardColumnVisibility extends Equatable {
  ...
  /// Status names whose board column is currently hidden. An empty set
  /// (the default) means "nothing hidden — every column visible," the
