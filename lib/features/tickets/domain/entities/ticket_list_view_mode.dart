...
/// `_TicketViewMode` enum to a shared domain type, since the selection is now
/// read/written from three places (`TicketsCubit`,
/// `TicketListViewModeRepository`, and the screen itself) instead of one. See
/// `AIO-1069` §2.1.
