...
void main() {
  test(
    'a fresh onCreate install can write and read ticketsRootPath',
    () async {
  ...
  group('schema 2 — ticketsRootPath column', () {
    ...
    test(
      'an install upgraded from schema 1 keeps its existing row, with '
    ...
    test(
      'an install upgraded from schema 1 can write ticketsRootPath on a '
      'new row',
      () async {
        final database = RegistryDatabase(
          NativeDatabase.memory(
